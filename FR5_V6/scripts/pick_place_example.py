...
target_position = np.array([-0.3, 0.2, 0])
target_position[2] = 0.0515 / 2.0
cube_initial_orientation =  np.array([-0.3, -0.2, 0])
my_task = PickPlace(name="fr_pick_place", 
...
task_params = my_world.get_task("fr_pick_place").get_params()
