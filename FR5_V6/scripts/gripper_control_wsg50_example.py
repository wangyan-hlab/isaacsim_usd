...
asset_path = os.path.join(os.getcwd(), "FR5_V6/usd/FR5_V6_WSG50/FR5_V6_WSG50_table.usd")
    ...
    if my_world.is_playing():
        ...
        if i < 100:
            ...
            my_fr.gripper.apply_action(
                ArticulationAction(joint_positions=[gripper_positions[0] - 0.0005, gripper_positions[1] - 0.0005]))
        if i > 100:
