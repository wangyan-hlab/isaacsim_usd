...
import numpy as np
from tasks.pick_place_table_dhpgi80 import PickPlace
...
task_params = my_world.get_task("fr_pick_place_table_dhpgi80").get_params()
...
while simulation_app.is_running():
    ...
    if my_world.is_playing():
        ...
        actions = my_controller.forward(
            ...
            end_effector_offset=np.array([0, 0, 0.175]),
